...
import ProgressTracker from '../../components/ProgressTracker' // 컴포넌트 import
...
function Cognition() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      setTimeout(() => {
        setAiGeneratedImage(`https://via.placeholder.com/400x400/00C8B3/ffffff?text=${encodeURIComponent(objectName)}`)
    ...
    <div className="cognition-page">
      ...
      <main className="lesson-main">
        ...
        <div className="control-panel">
            ...
            <div className="panel-section guide-section">
              ...
              <div className="guide-list">
                <div className="guide-point">
                  ...
                  <p>그린 것의 <strong>이름</strong>을 알려주기</p>
                </div>
                <div className="guide-point">
                  <span className="point-num">2</span>
                  <p><strong>그림 + 명사</strong> = AI의 이해</p>
                </div>
              </div>
            </div>
          )}
          ...
          {/* 텍스트 입력 */}
          <div className="panel-section">
            <h3 className="section-title">✍️ 사물의 이름</h3>
            <input
              type="text"
            ...
            <div className="result-content">
              ...
              <div className="result-info">
                ...
                <p className="result-text">
                  AI가 <strong>"{objectName}"</strong>을(를) 이해했어요!
                </p>
                <div className="learning-box">
                  <h4>💡 학습한 개념</h4>
                  <p><strong>그림 + 명사 = AI의 이해</strong></p>
                  <p className="learning-desc">
                    내가 그린 것의 '이름'을 알려주는 것이 AI와의 소통의 첫걸음입니다.
                  </p>
                </div>
